...
from .players import HumanPlayer, NondeterministicAIPlayer, EnumerativeAIPlayer, TrainedAIPlayer
...
parser.add_argument('--no-gui', help="Print very little to the screen", action="store_false")
